  ...
  return (
    <div className="audit-results-container">
      ...
      <div className="audit-results-banner">
        <h1 className="audit-results-text06">Learn to keep it simple</h1>
      ...
      <div className="audit-results-features">
        <h1 className="audit-results-text11">
          <span>Discover our</span>
          <br></br>
          <span>Top Recommendations</span>
        </h1>
        <div className="audit-results-separator"></div>
      ...
      <div className="audit-results-footer">
        <footer className="audit-results-container08">
          <img
            alt="image"
            src="/playground_assets/logotype-light.svg"
            className="audit-results-image1"
          />
          <div className="audit-results-container09">
            <span className="audit-results-text15 body2">
