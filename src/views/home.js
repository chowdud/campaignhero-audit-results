...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>CampaignHero Audit Results</title>
        <meta property="og:title" content="CampaignHero Audit Results" />
      </Helmet>
        ...
        <div className="home-hero">
          <div className="home-container06">
            <h1 className="home-text06 headline1">
              <span>Audit &amp; Improve Your Ad Campaigns.</span>
            </h1>
            <PrimaryButton button="Connect &amp; Audit"></PrimaryButton>
          </div>
        </div>
      </div>
      ...
      <div className="home-features">
        <h2 className="headline2 home-text08">Tailor-made features</h2>
      ...
      <div className="home-footer">
        <footer className="home-container17">
          ...
          <div className="home-container18">
            <span className="home-text19 body2">
